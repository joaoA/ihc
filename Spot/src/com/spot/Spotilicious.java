...
public class Spotilicious extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mItems.add("Procura por proximidade");
		mItems.add("Procura por cozinha");
		mItems.add("Procura por preço");
		mItems.add("Procura multimodal");
		mItems.add("Histórico");
		mItems.add("Favoritos");
